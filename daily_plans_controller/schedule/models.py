...
class Task(models.Model):
    ...
    postponed = models.DurationField(blank=True,
                                     null=True,
                                     choices=[
    ...
    deadline_reminder = models.DurationField(
        blank=True,
        null=True,
        choices=[(timedelta(weeks=-1), 'Week before'),
    ...
    postponed_reminder = models.DurationField(
        blank=True,
        null=True,
        choices=[(timedelta(weeks=-1), 'Week before'),
                 (timedelta(days=-2), '2 days before'),
...
class Event(models.Model):
    ...
    repeatable = models.DurationField(default=timedelta(weeks=4),
                                      choices=[(timedelta(days=1), 'Daily'),
    ...
    reminder = models.DurationField(
        ...
        choices=[(timedelta(weeks=-4), 'Month before'),
    ...
    def __str__(self):
        return "Event(name={}, repeatable={})".format(self.name,
                                                      self.repeatable)
...
class Reminder(models.Model):
    ...
    def __str__(self):
        return "Reminder(name={}, repeatable={})".format(
            self.name, self.repeatable)
